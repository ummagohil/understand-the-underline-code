...
if (!API_KEY) {
  ...
  // alert("Gemini API key is not configured. The application may not function correctly.");
}
...
export const getExplanationForImageRegion = async (annotatedImageDataBase64: string): Promise<string> => {
  if (!API_KEY) {
