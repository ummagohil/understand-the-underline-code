  ...
  return (
    <div className="bg-slate-700 p-4 rounded-lg shadow-md">
      ...
      <label
        ...
        onDrop={handleDrop}
        className={`flex flex-col items-center justify-center w-full h-32 px-4 transition bg-slate-600 border-2 border-slate-500 border-dashed rounded-md appearance-none cursor-pointer hover:border-sky-400 focus:outline-none ${
